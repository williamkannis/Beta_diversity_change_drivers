...
# No null mode exists for taxonomic beta diversity, so you need to manually 
...
his_tax_lcbd <- his_tax_obs[[2]]  # used to calculated DLCBD, and as a predictor in RDA
mod_tax_lcbd <- mod_tax_obs[[2]]  # used only to calculate DLCBD, no further use
